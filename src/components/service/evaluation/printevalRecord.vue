  ...
  <div id="wd-Evalreport">
    ...
    <div v-else>
      ...
      <header>
        ...
        <div v-if="showList == 1" style="display:none;">
          <span>
            <!--
        ...
        <section>
          ...
          <table class="wd-jcxxtable">
            ...
            <tr>
              ...
              <td v-if="reportdatas.handedness==2">右利手</td>
              <td v-if="reportdatas.handedness==3">双利手</td>
              <td>年龄</td>
...
<script>
  ...
  import evaluationModal from '../case/evaRecord/evaluationModal.vue'
  var eChart = require('../../assets/js/echarts.simple.min.js');
...
//          console.log(previewSwiper.activeIndex,previewSwiper.slides)
      ...
      printDetail:function(){
          var self = this;
          var uid = self.$route.params.uid;
          var type = self.$route.params.type;
          var reportid = self.$route.params.reportid;
          var aid = self.$route.params.aid;
          if(type==1){
            self.showList = 1;
            self.showWAB = 1;
            self.show_1_0 = 0;
            self.getRecordDetails(reportid);
          }else{
            self.showList = 1;
            self.showWAB = 0;
            self.show_1_0 = 1;
